#ifndef SDCC
  #pragma noiv               // Do not generate __interrupt vectors
#endif
//-----------------------------------------------------------------------------
//   File:      slave.c
...
//  FIFOPINPOLAR |= 0x03;
  ...
  SYNCDELAY;
  PORTACFG |= 0x80;
  //IFCONFIG = 0xE3; // internal clock source, and IFCLK output
  //IFCONFIG = 0xB3; // internal clock source, and no IFCLK output
  IFCONFIG = 0x03; // external clock source	
...
//-----------------------------------------------------------------------------
// USB __interrupt Handlers
//   The following functions are called by the USB __interrupt jump table.
//-----------------------------------------------------------------------------

// Setup Data Available __interrupt Handler
void ISR_Sudav( void )
#ifndef SDCC
  __interrupt 0
#else
